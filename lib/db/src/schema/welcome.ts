...
export const welcomeConfigsTable = pgTable("welcome_configs", {
  ...
  embedAuthor: text("embed_author"),
  embedTimestamp: boolean("embed_timestamp").notNull().default(false),
  ...
  cardBackgroundUrl: text("card_background_url"),
  cardTextColor: text("card_text_color"),
  cardAvatarBorderColor: text("card_avatar_border_color"),
  cardWelcomeText: text("card_welcome_text"),
...
export const goodbyeConfigsTable = pgTable("goodbye_configs", {
  ...
  cardTextColor: text("card_text_color"),
  cardAvatarBorderColor: text("card_avatar_border_color"),
  cardGoodbyeText: text("card_goodbye_text"),
  createdAt: timestamp("created_at", { withTimezone: true }).notNull().defaultNow(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).notNull().defaultNow().$onUpdate(() => new Date()),
});
